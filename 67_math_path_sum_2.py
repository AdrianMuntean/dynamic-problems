'''
Problem 67 from https://projecteuler.net/problem=67.
Find the maximum total from top to bottom in p067.txt , a 15K text file containing a triangle with one-hundred rows.
'''
